        ...
        <div className='flex-1 overflow-y-auto space-y-4'>
          {filteredLogs.length === 0 ? (
            ...
            filteredLogs.map(log => (
              <div
                key={log.id}
                className={`bg-linear-to-br ${getIntensityColor(log.intensity)} border rounded-xl p-4 hover:scale-[1.02] transition-all duration-300 group`}
              >
                <div className='flex items-center justify-between gap-2 sm:gap-3'>
                  ...
                  <div className='flex items-center gap-2 sm:gap-3 shrink-0'>
                    ...
                    <button
                      ...
                      className='opacity-0 group-hover:opacity-100 p-2 hover:bg-red-500/20 rounded-lg transition-all text-red-400 hover:text-red-300 disabled:opacity-50 shrink-0'
                    >
                      <Trash2 size={16} />
                    </button>
                  </div>
