...
export const ChatWindow = ({
  ...
  return (
    <div className='flex-1 flex flex-col h-full bg-[#1e1416]'>
      ...
      <div className='p-6 bg-[#1a0F16] border-t border-white/10 flex-shrink-0'>
        <div className='flex items-end gap-3'>
          <Textarea
            ...
            disabled={isLoading}
            className='min-h-[56px] max-h-32 bg-[#322840]/60 border-white/10 text-white placeholder:text-gray-500 resize-none pr-4 disabled:opacity-50 focus-visible:ring-[#D98A9D]'
            rows={1}
          />
          <Button
            onClick={handleSend}
            disabled={!inputMessage.trim() || isSending || isLoading}
            className='bg-gradient-to-br from-[#D98A9D] to-[#ec1380] hover:from-[#c87b8f] hover:to-[#d11371] text-white h-14 px-6 rounded-xl font-semibold shadow-lg shadow-[#D98A9D]/20 transition-all'
          >
